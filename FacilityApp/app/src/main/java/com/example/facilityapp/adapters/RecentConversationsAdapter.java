...
import com.example.facilityapp.databinding.ItemContainerConversationsBinding;
...
public class RecentConversationsAdapter extends RecyclerView.Adapter<RecentConversationsAdapter.ConversationViewHolder> {
    ...
    public ConversationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ConversationViewHolder(
                ItemContainerConversationsBinding.inflate(
    ...
    class ConversationViewHolder extends RecyclerView.ViewHolder{
        ...
        ItemContainerConversationsBinding binding;

        ConversationViewHolder(ItemContainerConversationsBinding itemContainerConversationsBinding){
            super(itemContainerConversationsBinding.getRoot());
            binding = itemContainerConversationsBinding;
        }
