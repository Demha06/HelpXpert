...
import com.example.facilityapp.databinding.ItemContainerUserBinding;
...
public class AdminAdapter extends RecyclerView.Adapter<AdminAdapter.UserViewHolder>{
    ...
    class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        void setUserData(User admin){
            binding.textName.setText(admin.name);
            binding.textEmail.setText(admin.email);
            binding.imageProfile.setImageBitmap(getUserImage(admin.image));
        }
    }
